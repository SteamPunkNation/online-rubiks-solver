...
const CUBIE_SPACING = 0.62
const CUBIE_SIZE = 0.56
...
const invertTurn = (turn) => {
  if (turn.includes('2')) return turn
  if (turn.includes("'")) return turn[0]
  return turn + "'"
}
...
function App() {
  ...
  const normalizeRgb = (r, g, b) => {
    ...
    // Limit scale to avoid artificially brightening dark shadows/backgrounds
  ...
  const closestPaletteColor = (r, g, b) => {
